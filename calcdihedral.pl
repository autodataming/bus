...
sub calcdiheangle
{
	...
	$atom4{'x'}=$hash{$atomnums[3]}{'x'};
	 ...
	 my $v1=V($atom2{'x'}-$atom1{'x'},$atom2{'y'}-$atom1{'y'},$atom2{'z'}-$atom1{'z'});
   my $v2=V($atom3{'x'}-$atom2{'x'},$atom3{'y'}-$atom2{'y'},$atom3{'z'}-$atom2{'z'});
   my $v3=V($atom4{'x'}-$atom3{'x'},$atom4{'y'}-$atom3{'y'},$atom4{'z'}-$atom3{'z'});
       my $v3_x_v2 = $v3 x $v2;   #cross-product
    my $v2_x_v1 = $v2 x $v1;
    my $sign = $v1 * $v3_x_v2;
